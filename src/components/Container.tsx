...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Zulfa Adzin Kautsar",
    description: `Web Developer Intern di CV Grobmart & Mahasiswa S1 Terapan Sistem Informasi Kota Cerdas, Politeknik Negeri Indramayu.`,
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://zulfa-portfolio.vercel.app${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://zulfa-portfolio.vercel.app${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Zulfa Adzin Kautsar" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="Zulfa Adzin Kautsar" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">zulfa</span>
        </Link>
              ...
              <div className="flex h-full flex-col items-start justify-between overflow-y-auto">
                ...
                <div className="flex min-h-fit w-full flex-col space-y-8 px-[22px] py-10">
                  <span className="text-sm text-muted-foreground">
                    © {new Date().getFullYear()} Zulfa Adzin Kautsar. All rights reserved.
                  </span>
                </div>
              </div>
            </motion.div>
